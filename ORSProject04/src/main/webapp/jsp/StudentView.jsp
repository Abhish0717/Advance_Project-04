	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div class="card-header text-white border-0 py-3 px-4"
			...
			<h5 class="mb-0 fw-bold">
				...
				<%=bean.getId() > 0 ? ms.get("student.edit") : ms.get("student.add")%>
			</h5>
		</div>
		...
		<div class="card-body px-4 py-4">
			...
			<form action="StudentCtl" method="POST">
				...
				<div class="mb-3">
					<label class="form-label fw-semibold"><%=ms.get("college.title")%> <span
				...
				<div class="mb-3">
					...
					<div class="input-group">
						<input type="text" name="dob" placeholder="<%=ms.get("register.selectdob") %>" id="udate" class="form-control" readonly
				...
				<div class="mb-3">
					<label class="form-label fw-semibold"><%=ms.get("mobile.title")%><span
						class="text-danger">*</span></label> <input type="text" name="mobileNo" placeholder="<%=ms.get("mobile.placeholder")%>"
						class="form-control"
				...
				<div class="mb-4">
					<label class="form-label fw-semibold"><%=ms.get("email.id")%> <span
						class="text-danger">*</span></label> <input type="text" name="email" placeholder="<%=ms.get("email.placeholder")%>"
						class="form-control"
				...
				<div class="d-flex gap-2 pt-2 border-top">
					...
					%>
					<a href="StudentCtl" class="btn btn-danger ms-auto"> <i
