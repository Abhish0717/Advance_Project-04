	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div class="card-header text-white border-0 py-4 px-4 text-center"
			...
			<h5 class="mb-1 fw-bold">
				<ors:message key="forget.title" />
			</h5>
			<p class="mb-0 opacity-75 small">
				<ors:message key="forget.cardsubtitle" />
			</p>
		</div>
			...
			<form action="<%=ORSView.FORGET_PASSWORD_CTL%>" method="POST">
				...
				<div class="mb-4">
					<label class="form-label fw-semibold"><ors:message
							key="forget.loginid" /><span class="text-danger">*</span></label> <input
						type="text" name="login" class="form-control form-control-lg"
						placeholder="<ors:message key="forget.enteremail" />"
				...
				<button type="submit" name="operation"
					...
					<i class="bi bi-send me-2"></i> <ors:message key="forget.sendpassword" />
				</button>
