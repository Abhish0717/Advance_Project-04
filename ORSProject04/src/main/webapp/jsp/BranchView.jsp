			...
			<form action="<%=ORSView.BRANCH_CTL%>" method="POST">
				...
				<div class="mb-3">
					<label class="form-label fw-semibold">Manager Name <span
						class="text-danger">*</span></label> <input type="text" name="mname"
						placeholder="Enter Manager Name" class="form-control"
						maxlength="200"
						value="<%=DataUtility.getStringData(bean.getManagerName())%>">
					<div class="text-danger small mt-1"><%=ServletUtility.getErrorMessage("mname", request)%></div>
				</div>
				...
				<div class="d-flex gap-2 pt-2 border-top">
					...
					%>
					<a href="BranchCtl" class="btn btn-danger ms-auto"> <i
