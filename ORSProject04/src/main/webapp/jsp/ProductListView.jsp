<%@page import="com.sunilos.p4.ctl.ProductListCtl"%>
	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		<div
			...
			<h5 class="mb-0 fw-bold">
				<i class="bi bi-basket2 me-2"></i>Product Management List
			</h5>
			<div class="d-flex gap-2">
				<a href="<%=ORSView.PRODUCT_REPORT_CTL%>" target="_blank"
					...
					class="bi bi-plus-circle me-1"></i> Add Product Management
				</a>
			</div>
		</div>
		<form action="<%=ORSView.PRODUCT_LIST_CTL%>" method="POST">
			...
			<div
				...
				<button type="submit" name="operation"
					...
					onclick="return confirm('Delete selected Product?')">
