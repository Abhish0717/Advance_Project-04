	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4">
		<div class="card-header text-white border-0 py-3 px-4"
			...
			<h5 class="mb-0 fw-bold">
				<i class="bi bi-search me-2"></i><%=ms.get("marksheet.get")%></h5>
		</div>
		<div class="card-body px-4 py-4">
			...
			<form action="<%=ORSView.GET_MARKSHEET_CTL%>" method="POST">
				<label class="form-label fw-semibold"><%=ms.get("marksheet.rollno")%><span
	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		<div class="card-header border-0 py-3 px-4 bg-success text-white">
			<h6 class="mb-0 fw-bold">
				<i class="bi bi-file-earmark-check-fill me-2"></i><%=ms.get("marksheet.result")%></h6>
		</div>
			...
			<table class="table table-borderless mb-0">
				<tbody>
					...
					<tr class="border-bottom table-light">
						<th class="ps-4 py-3"><%=ms.get("marksheet.total")%><small
