	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<form action="<%=ORSView.BRANCH_LIST_CTL%>" method="POST">
			...
			<div
				...
				<input type="text" name="bname" class="form-control form-control-sm"
					style="max-width: 220px;" placeholder="Search by Branch Name"
					value="<%=ServletUtility.getParameter("bname", request)%>">
				...
				<button type="submit" name="operation"
					...
					onclick="return confirm('Delete selected Branch?')">
				...
				<table class="table table-hover align-middle mb-0">
					...
					<tbody>
						...
						<tr>
							...
							<td><a href="BranchCtl?id=<%=bean.getId()%>"
